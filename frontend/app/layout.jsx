...
export default function RootLayout({ children }) {
  ...
  const hideFooterRoutes = ["/signin", "/signup", "/game", '/spelling-bee', '/dewordle'];
  const hideNavbarRoutes = ["/signin", "/signup", "/admin-signin","/subadmin-signin", "/dewordle", "/game", "/spelling-bee", '/profile','/setting', '/stats', '/forgot-password', '/modes'];
